  ...
  return (
    <div className="min-h-screen bg-beatmap-dark flex items-center justify-center relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-beatmap-primary/20 rounded-full blur-[120px] animate-pulse"></div>
      ...
      <div className="relative z-10 max-w-md w-full px-6 text-center">
        ...
        <div className="space-y-4">
          <button 
            ...
            disabled={isLoading}
            className="w-full bg-[#1DB954] hover:bg-[#1ed760] text-black font-bold py-4 px-6 rounded-full transition-all transform hover:scale-105 flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(29,185,84,0.3)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
